...
const translations = {
  fr: {
    ...
    "hero.tag": "<i class='fas fa-utensils me-2'></i>Excellence Culinaire Camerounaise",
    ...
    "hours.title": "<i class='fas fa-clock me-2'></i>Horaires d'ouverture",
    "hours.everyday": "Tous les jours",
    "hours.note": "Ouvert 7j/7, de Lundi à Dimanche.",
  ...
  en: {
    ...
    "nav.contact": "Contact",
    "nav.reserve": "Book",
    "hero.tag": "<i class='fas fa-utensils me-2'></i>Cameroonian Culinary Excellence",
    ...
    "hours.title": "<i class='fas fa-clock me-2'></i>Opening Hours",
    "hours.everyday": "Every day",
    "hours.note": "Open 7 days a week, Monday to Sunday.",
